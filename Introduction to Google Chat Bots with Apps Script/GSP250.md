<h1 align="center">
✨ Introduction to Google Chat Bots with Apps Script || GSP250 ✨
<div align="center">
...
4.  📄 Copy and replace the *entire content* of the `Code.gs` file with the following JavaScript code:
    ...
    function onAddToSpace(event) {
      ...
      console.log('Friendly Bot added in ', event.space.name);
      return { "text": message };
    }
...
7.  🔍 Search for **`Friendly Bot`**.

8.  🖱️ From the search results, select the **Friendly Bot** (Apps Script lab bot) that you just configured, and click **Start chat**.
...
3.  💬 Go back to your Google Chat DM with the **Friendly Bot**. Type any message, for example: **`Hello`** and press Enter. You should see a card response now.
    ...
    function turnOnAutoResponder(reason) {
      ...
      try {
        Gmail.Users.Settings.updateVacation({
          ...
          responseBodyHtml: "I'm out of the office today; will be back on the next business day.<br><br><i>Created by Friendly Bot!</i>",
...
4.  💬 Go back to your Google Chat DM with the **Friendly Bot**. Type the message: **`I'm sick`** and press Enter.
