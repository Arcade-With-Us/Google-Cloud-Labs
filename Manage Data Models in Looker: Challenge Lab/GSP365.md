...
```
1. Make sure your Created Month column is in `Ascending order`
2. Save this visualization as a Look and name it according to your lab panel
## Task 3. Extend a view
## Create View: Paste the code below after creating the view.
```bash
view: VIEW_NAME {
extension: required
...
### Update the `user.view`: Change this GROUP_NAME according to the lab part for the users view.
```py
view: users {
...
```
### Update `product.view`: Change this GROUP_NAME according to lab part for product view
```py
view: products {
