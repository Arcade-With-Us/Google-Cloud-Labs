...
5. In the lower-left of your spreadsheet, click the sheet labeled `Items` to view the data specific to items from On the Rise Bakery.
6. To freeze the first row, at the top, click **View** > **Freeze** > **1 row**.
7. To sort by Number of Items in ascending order, right-click the heading for `column C`, and then click **`Sort sheet A to Z`**.
8. In the lower-left of your spreadsheet, click **Add Sheet (+)** to add another sheet.
9. Right-click the new sheet name, click **Rename**, and type **`Items Sorted By Unit Price`**
10. In cell A1 of the new sheet, **type or paste**
  ```
