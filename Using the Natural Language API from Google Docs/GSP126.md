...
---
1. To create an API key, select the Navigation menu > APIs & Services > Credentials.
2. Click Create credentials at the top and select API key:
---
## 💻 **For Task no.3**: [Open](https://docs.google.com/document/create) & Paste the Command In Blank Document  
