...
* Create your VM insatnce using this command:
```
curl -LO raw.githubusercontent.com/Arcade-With-Us/Google-Cloud-Labs/refs/heads/main/Block%20one%3A%20Getting%20Started%20with%20The%20EOSIO%20Blockchain/GSP873-1.sh

sudo chmod +x GSP873-1.sh
